        ...
        for(var i = 0 ; i < datafiles.length ; i++) {
                  if(datafiles[i].includes("txt")) {
                    for(var w = 0 ; w < datafiles.length ; w++) {
                      if(!datafiles[w].includes("txt") && datafiles[i].includes(datafiles[w].substring(0,datafiles[w].indexOf("."))) && datafiles[i].substring(0,datafiles[i].indexOf("_")) == retVal.substring(7))
